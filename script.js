...
let listeA = {
    ...
    'la# Mineure harmonique' : ['la#', 'si#', 'do#', 'ré#', 'fa', 'fa#', 'la', ""],
    ...
    'ré# Mineur naturel' : ['ré#', 'mi#', 'fa#', 'sol#', 'la#', "si#", "do#", ""], 
    ...
    'la# Mineur naturel' : ['la#', 'do', 'do#', 'ré#', 'mi#', "fa#", "sol#", ""], 
    ...
    'La# Blues Mineur' : ["la#", "do#", "ré#", "mi", "mi#", "sol#",""],
    'Si Blues Mineur' : ["si#", "ré#", "fa", "fa#", "sol", "la#",""],

    'Do Blues Majeur' : ["do", "ré", "ré#", "mi", "sol", "la",""],
    'Do# Blues Majeur' : ["do#", "ré#", "mi", "fa", "sol#", "la#",""],
    'Ré Blues Majeur' : ["ré", "mi", "fa", "fa#", "la", "si",""],
    'Ré# Blues Majeur' : ["ré#", "mi#", "fa#", "sol", "la#", "si#",""],
    ...
    'Sol# Blues Majeur' : ["sol#", "la#", "si", "si#", "ré#", "fa",""],
    'La Blues Majeur' : ["la", "si", "do", "do#", "mi", "fa#",""],
    'La# Blues Majeur' : ["la#", "si#", "do#", "ré", "fa", "sol",""],
    ...
    'Sol# Ionique (Majeure)' : ["sol#", "la#", "si#", "do#", "ré#", "fa", "sol",""],
    'La Ionique (Majeure)' : ["la", "si", "do#", "ré", "mi", "fa#", "sol#",""],
    'La# Ionique (Majeure)' : ["la#", "si#", "ré", "ré#", "mi#", "sol", "sol#",""],
    ...
    'Ré# Dorien' : ["ré#", "fa", "fa#", "sol#", "la#", "si#", "do#",""],
    ...
    'La# Dorien' : ["la#", "si#", "do#", "ré#", "fa", "sol", "sol#",""],
    ...
    'Do Lydienne' : ["do", "ré", "mi#", "fa#", "sol", "la", "si",""],
    'Do# Lydienne' : ["do#", "ré#", "fa", "sol", "sol#", "la#", "si#",""],
    'Ré Lydienne' : ["ré", "mi", "fa#", "sol#", "la", "si", "do#",""],
    'Ré# Lydienne' : ["ré#", "fa", "sol", "la", "la#", "si#", "ré",""],
    'Mi Lydienne' : ["mi", "fa#", "sol#", "la#", "si", "do#", "ré#",""],
    'Fa Lydienne' : ["fa", "sol", "la", "si", "do", "ré", "mi",""],
    'Fa# Lydienne' : ["fa#", "sol#", "la#", "si#", "do#", "ré#", "fa",""],
    ...
    'Do# Mixolydienne' : ["do#", "ré#", "mi#", "fa#", "sol#", "la#", "si",""],
    'Ré Mixolydienne' : ["ré", "mi", "fa#", "sol", "la", "si", "do",""],
    'Ré# Mixolydienne' : ["ré#", "mi#", "sol", "sol#", "la#", "si#", "do#",""],
    'Mi Mixolydienne' : ["mi", "fa#", "sol#", "la", "si", "do", "ré",""],
    'Fa Mixolydienne' : ["fa", "sol", "la", "la#", "do", "do#", "ré#",""],
    'Fa# Mixolydienne' : ["fa#", "sol#", "la#", "si", "do#", "ré", "mi",""],
    'Sol Mixolydienne' : ["sol", "la", "la#", "do", "ré", "ré#", "fa",""],
    'Sol# Mixolydienne' : ["sol#", "la#", "si", "do#", "ré#", "mi", "fa#",""],
    ...
    ' Fa Locrienne' : ["fa", "fa#", "sol#", "la#", "si#", "do#", "ré#",""],
